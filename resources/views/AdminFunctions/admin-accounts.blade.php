                    ...
                    <tbody id="results">
                        ...
                        <tr class="bg-[#FDC500] bg-opacity-25">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <a href="#" data-modal-target="deleteModal" data-modal-show="deleteModal" class="font-medium hover:underline text-custom-red">Delete</a>
                            </td>
                        </tr>
                    @else
        ...
        <form action="">
            <div class="p-4 overflow-y-auto w-[30rem]">
                ...
                <div class="mb-3 md:mb-5 flex-1 flex-col">
                    ...
                    @error('yearLevel') <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p> @enderror
                </div>
                <div class="mb-3 md:mb-5 flex-1 flex-col">
                ...
                <div class="mb-3 md:mb-5 flex-1 flex-col">
                    <label for="office" class="block text-sm font-medium text-gray-900 dark:text-white mb-1">Office</label>
                        <input
                            ...
                            placeholder="Office"
                        >
                    @error('office') <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p> @enderror
                </div>
            </div>
    ...
    <div class="relative w-full max-w-md max-h-full flex items-center">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                ...
                <button @click="console.log(1)" data-modal-hide="deleteModal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Yes, I'm sure
                </button>
