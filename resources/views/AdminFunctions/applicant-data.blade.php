        ...
        <div class="w-full p-10 flex justify-between">
            <div class="flex gap-10">
                ...
                <div class="flex flex-col gap-5">
                    <h1 class="text-6xl font-bold font-quicksand">John Doe</h1>
                    <div class="flex flex-col font-quicksand font-medium gap-2">
                        <span>johndoe@gmail.com</span>
                        <span>09070070832</span>
                    </div>
                </div>
            </div>
            <div class="flex flex-col gap-2 mr-16">
                ...
                <a href="#" class="font-medium hover:underline flex gap-2 items-center bg-custom-red w-fit py-2.5 px-5 rounded-2xl text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
