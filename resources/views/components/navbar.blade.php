<nav x-data="{ open: false }" @keydown.window.escape="open = false" class="bg-white font-quicksand border-b-4 border-b-blue-700 fixed top-0 left-0 w-full z-[1000]">
  <div class="mx-28 xl:mx-24 2xl:mx-28 xl:px-6 2xl:px-8">
      ...
      <div class="flex items-center flex-grow">
        ...
        <div class="hidden xl:block">
          <div class="flex items-center ">
            <a href="#" class="nav--top flex flex-row items-center xl:px-2 2xl:px-3 py-2 text-sm font-medium text-black rounded-md focus:outline-none focus:text-black">
              <span class="ml-2">HOME</span>
            </a>
            {{-- <a href="#" class="flex flex-row items-center xl:px-2 2xl:px-3 py-2 ml-4 text-sm font-medium text-black rounded-md hover:text-black  focus:outline-none focus:text-black">
              <span class="ml-2">About Us</span>
            </a> --}}
            <div class="relative" x-data="{ open: false}">
                <button @click="open = !open" class="nav--top flex flex-row items-center xl:px-2 2xl:px-3 py-2 text-sm font-medium text-black rounded-md hover:text-black  focus:outline-none focus:text-black">
            ...
            <div class="relative" x-data="{ open: false}">
                ...
                <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opaity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute left-0 w-48 mt-2 origin-top-right rounded-md shadow-lg" style="display: none; z-index:100">
                  <div class="py-1 bg-white rounded-md shadow-xs">
                    <div class="relative" x-data="{ open: false}">
                        <a href="#" @click="open = !open" class="nav--top flex flex-row items-center px-4 py-2 text-sm text-gray-700 focus:text-gray-900 hover:text-gray-900 focus:outline-none hover:bg-gray-100 focus:bg-gray-100">
                          TECH4ED
        ...
        <div class="flex items-center 2xl:ml-6">
          <div @click.away="open = false" class="relative ml-3" x-data="{ open: false }">
            <div class="flex items-center gap-6">
              ...
              <button @click="open = !open" class="flex items-center w-[33px] h-[33px] text-sm text-black rounded-full focus:outline-none focus:shadow-solid" id="user-menu" aria-label="User menu" aria-haspopup="true" x-bind:aria-expanded="open">
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opaity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute left-0 w-48 mt-2 origin-top-right rounded-md shadow-lg">
              <div class="py-1 bg-white rounded-md shadow-xs">
                ...
                <a href="#" class="nav--top flex flex-row items-center px-4 py-2 text-sm text-red-500 hover:text-red-700 hover:bg-red-100 focus:outline-none focus:text-red-700 focus:bg-red-100">
  ...
  <div :class="{'block': open, 'hidden': !open}" class="hidden xl:hidden">
    <div class="container px-6 mx-auto">
      <div class="pt-2 pb-3">
            <a href="#" class="flex flex-row items-center px-3 py-2 text-sm font-medium text-black rounded-md focus:outline-none focus:text-black">
              <span class="ml-2">HOME</span>
            </a>
            {{-- <a href="#" class="flex flex-row items-center px-3 py-2 ml-4 text-sm font-medium text-black rounded-md hover:text-black  focus:outline-none focus:text-black">
              <span class="ml-2">About Us</span>
            </a> --}}
            <div class="relative" x-data="{ open: false}">
                <button @click="open = !open" class="flex flex-row items-center px-3 py-2 text-sm font-medium text-black rounded-md hover:text-black  focus:outline-none focus:text-black">
                  <span class="mx-2">About Us</span>
                  <svg xmlns="http://www.w3.org/2000/svg" :class="{'rotate-180': open, 'rotate-0': !open}" class="w-4 h-4 mt-1 transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                </button>
                <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opaity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute left-0 w-48 mt-2 origin-top-right rounded-md shadow-lg" style="display: none; z-index:100">
                ...
                <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opaity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute left-0 w-48 mt-2 origin-top-right rounded-md shadow-lg" style="display: none; z-index:100">
                  <div class="py-1 bg-white rounded-md shadow-xs">
                    <div class="relative" x-data="{ open: false}">
                        ...
                        <div @click.away="open = false" x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opaity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute top-full left-0 w-full mt-2 origin-top-left rounded-md shadow-lg bg-white" style="z-index: 101">
                          <a href="#" class="flex flex-row items-center px-4 py-2 text-sm text-gray-700 focus:text-gray-900 hover:text-gray-900 focus:outline-none hover:bg-gray-100 focus:bg-gray-100">
                            Digital Literacy Training Courses Offered
                          </a>
                          <a href="#" class="flex flex-row items-center px-4 py-2 text-sm text-gray-700 focus:text-gray-900 hover:text-gray-900 focus:outline-none hover:bg-gray-100 focus:bg-gray-100">
