<header class="z-10 py-4 bg-[#F2F7FF] dark:bg-gray-800" x-data="{isNotificationsMenuOpen:false, isProfileMenuOpen: false}">
    <div
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="relative">
                <button
                    ...
                    @click="isNotificationsMenuOpen = true; console.log(121)"
