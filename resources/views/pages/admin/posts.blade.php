        ...
        @if($posts)
            @foreach($posts as $post)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        <a href="#" type="button" wire:click="$emit('postModalPopulator', {{ $post->id }})" data-modal-target="add-post" data-modal-show="add-post" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit user</a>
