...
<div class = 'justify-center'>
    ...
    <br>
    <br>
    <h2 class = 'text-base font-bold'>III. Resource-sharing and Capacity Building</h2>
    <br>
    <p>(f) Harmonize and coordinate all national ICT plans and initiatives to ensure knowledge, information and resource-sharing, database-building and agency networking linkages among government agencies, consistent with E-Government objectives in particular, and national objectives in general;
        <br>
        <br>
        ...
        <br>
        <br>
        <h2 class = 'text-base font-bold'>IV. Consumer Protection and Industry Development</h2>
        <br>
