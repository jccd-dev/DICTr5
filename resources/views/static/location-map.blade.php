...
<div class = 'justify-center container mx-auto'>
    ...
    <h1 class = 'text-3xl font-bold'>DICT Region V - Camarines Sur Address</h1>
        ...
        <hr>
        <br>
            <h2 class =  'text-xl'>The Department of Information and Communications Technology Region V office is currently stationed at Sto. Domingo, Camaligan Camarines Sur besides the Camaligan Town Hall.</h2>
