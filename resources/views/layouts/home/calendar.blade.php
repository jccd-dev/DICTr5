                    ...
                    <div class="flex flex-wrap" x-data="{ isToday: isToday }" >
                        ...
                        <template x-for="(date, dateIndex) in no_of_days" :key="dateIndex">
                            <div style="width: 14.28%; height: 70px" class="flex justify-center items-center">
                                ...
                                <div x-show="!isToday(date)" class="px-2 py-2 cursor-pointer flex w-full justify-center">
                                    <p class="text-base text-gray-500 dark:text-gray-100 font-medium" x-text="date"></p>
                                </div>
                            </div>
                        </template>
                        {{-- <div class="px-2 py-2 cursor-pointer flex w-full justify-center">
