...
<div class="h-6 2xl:h-10 w-full bg-custom-blue flex justify-end">
    <div class="flex items-center gap-5 h-full px-10">
        <a href="#" class="w-5 2xl:w-7 opacity-50 hover:opacity-100">
        ...
        <a href="#" class="w-5 2xl:w-7 opacity-50 custom:opacity-90 hover:opacity-100">
