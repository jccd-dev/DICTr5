<div class="p-2">
    <div class="flex flex-row">
        <div class="basis-3/5 bg-slate-500">
            <div class="flex flex-row">
                <div>
                    <input type="date" name="from" id="from" wire:model="from">
                </div>
                <div>
                    <input type="date" name="to" id="to" wire:model="to">
                </div>
                <div>
        ...
        <div class="basis-2/5 bg-slate-300">
            <div class="flex flex-row-reverse">
                <div>
                    <button onclick="modalHandler(true)">Add</button>
                </div>
                <div>
                    <input type="text" wire:model="search" id="search" class="border-2 rounded-md p-1 shadow-lg">
                </div>
            </div>
        </div>
    </div>
