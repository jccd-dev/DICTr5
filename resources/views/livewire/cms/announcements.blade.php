<div class="p-2">
    <div class="flex flex-row">
        <div class="basis-3/5">
            <div class="flex flex-row">
                <div class="p-3">
                    <input class="p-1 rounded drop-shadow-lg" type="date" name="from" id="from" wire:model="from">
                </div>
                <div class="p-3 mt-2">
                    <span class="">-</span>
                </div>
                <div class="p-3">
                    <input class="p-1 rounded drop-shadow-lg" type="date" name="to" id="to" wire:model="to">
                </div>
                <div class="p-3">
        ...
        @forelse ($announcements as $ann)
            <tr>
                ...
                <td class="text-center">
                    <button wire:click="to_update_announcement('{{$ann->id}}')" onclick="updateModalHandler(true)" class="px-2 py-1 m-1 mr-0 bg-[#00509D] bg-opacity-40 rounded-md">Edit</button>
        ...
        <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-2xl">
            <div class="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                <form wire:submit.prevent="create_announcement">
                    @csrf
                    <h1 class="text-gray-800 font-lg font-bold tracking-normal leading-tight mb-4">Create Announcement</h1>
                    ...
                    <div class="mb-5 mt-2">
                        <select wire:model="insertAnnArray.cat_id" class="text-gray-600 focus:border focus:border-indigo-700 font-normal w-1/2 h-10 pl-3 text-sm border-gray-300 rounded border @error('cat_id') {{'border-red-600'}} @enderror">
