                    ...
                    @foreach($posts as $post)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <a href="#" type="button" data-modal-target="deleteModal3" data-modal-show="deleteModal3" @click="deletePostID = {{ $post->id }}" class="font-medium text-red-600 dark:text-red-500 hover:underline">Delete user</a>
                            </td>
                        </tr>
                    @endforeach
                @endif
