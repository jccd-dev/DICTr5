        ...
        <form action="#" method="POST" wire:submit.prevent="update_users_data({{ $user_data[0]->id }})" class="w-full flex flex-col">
            <div x-show="state == 1" class="w-full flex flex-col items-center">
                ...
                <div class="flex justify-start w-full">
                    <div class="">
                        <div class="mb-4">
                            <input id="default-checkbox" type="checkbox" wire:model="retaker" value="yes" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
