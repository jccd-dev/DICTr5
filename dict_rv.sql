...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2023 at 09:40 AM
...
INSERT INTO `announcements` (`id`, `cat_id`, `admin_id`, `title`, `excerpt`, `content`, `author`, `status`, `start_duration`, `end_duration`, `timestamp`) VALUES
                                                                                                                                                               (44, 2, 1, 'sdssd', 'hfhgfh', '<p>adsadasdd</p>\n', 'Anonymous', 1, '2023-05-02 13:50:50', '2023-05-03 00:00:47', '2023-05-08 06:46:29'),
...
CREATE TABLE `feedbacks` (
                             ...
                             `is_tech4ed` tinyint(2) DEFAULT 0,
                             `organization` varchar(250) DEFAULT NULL,
                             `tech4ed_course_training` varchar(250) DEFAULT NULL,
                             `timestamp` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `visitor_count` (`id`, `visitors`) VALUES
    (1, 5);
